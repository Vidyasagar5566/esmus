...
const Contact = () => {
    useDocTitle('Esmus - Send us a message')
            ...
            <div className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 bg-gray-200">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel: 8310045115</p>
                        
                            <div className='mt-5'>
                                <h2 className="text-2xl">Send an E-mail</h2>
                                <p className="text-gray-400">studentcommunity.iit.nit@gmail.com</p>
                            </div>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        <a href="https://www.linkedin.com/company/esmus/about/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 inline-block mx-1 text-center pt-1">
